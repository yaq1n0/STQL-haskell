...
/* package swish-0.10.1.0 */
#ifndef VERSION_swish
#define VERSION_swish "0.10.1.0"
#endif /* VERSION_swish */
#ifndef MIN_VERSION_swish
#define MIN_VERSION_swish(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  10 || \
  (major1) == 0 && (major2) == 10 && (minor) <= 1)
#endif /* MIN_VERSION_swish */
...
#define CURRENT_COMPONENT_ID "PLC-0.1.0.0-inplace-PLC"
